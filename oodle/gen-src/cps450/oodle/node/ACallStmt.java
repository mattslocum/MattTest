...
{
    private PExpPeriod _expPeriod_;
    private TId _id_;
    ...
    public ACallStmt(
        @SuppressWarnings("hiding") PExpPeriod _expPeriod_,
    ...
    public PExpPeriod getExpPeriod()
    {
        return this._expPeriod_;
    }

    public void setExpPeriod(PExpPeriod node)
    {
        if(this._expPeriod_ != null)
        {
            this._expPeriod_.parent(null);
        }
    ...
    {
        // Remove child
        if(this._expPeriod_ == child)
        {
            this._expPeriod_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._expPeriod_ == oldChild)
        {
            setExpPeriod((PExpPeriod) newChild);
            return;
        }
