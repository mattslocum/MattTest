...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTClassKw(@SuppressWarnings("unused") TClassKw node)
    {
        this.index = 3;
    }
    ...
    @Override
    public void caseTLtOp(@SuppressWarnings("unused") TLtOp node)
    {
        this.index = 27;
    }
    ...
    @Override
    public void caseTGteqOp(@SuppressWarnings("unused") TGteqOp node)
    {
        this.index = 30;
    }
    ...
    @Override
    public void caseTAsignOp(@SuppressWarnings("unused") TAsignOp node)
    {
        this.index = 36;
    }
    ...
    @Override
    public void caseTLBar(@SuppressWarnings("unused") TLBar node)
    {
        this.index = 39;
    }

    @Override
    public void caseTRBar(@SuppressWarnings("unused") TRBar node)
    {
        this.index = 40;
    }
